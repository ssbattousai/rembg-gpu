...
class BaseSession:
    ...
    def __init__(self, model_name: str, sess_opts: ort.SessionOptions, *args, **kwargs):
        ...
        # Force providers to CUDA + CPU if available
        ...
        # ✅ No TensorRT here
        model_paths = self.__class__.download_models(*args, **kwargs)
        if isinstance(model_paths, (list, tuple)):
            model_path = model_paths[0]  # use the first model path if multiple are returned
        else:
